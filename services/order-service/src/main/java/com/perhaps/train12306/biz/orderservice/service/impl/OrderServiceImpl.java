package com.perhaps.train12306.biz.orderservice.service.impl;
...
import com.perhaps.train12306.biz.orderservice.dto.req.*;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.rocketmq.client.producer.SendResult;
import org.apache.rocketmq.client.producer.SendStatus;
import com.perhaps.train12306.biz.orderservice.common.enums.OrderCanalErrorCodeEnum;
import com.perhaps.train12306.biz.orderservice.common.enums.OrderItemStatusEnum;
import com.perhaps.train12306.biz.orderservice.common.enums.OrderStatusEnum;
import com.perhaps.train12306.biz.orderservice.dao.entity.OrderDO;
import com.perhaps.train12306.biz.orderservice.dao.entity.OrderItemDO;
import com.perhaps.train12306.biz.orderservice.dao.entity.OrderItemPassengerDO;
import com.perhaps.train12306.biz.orderservice.dao.mapper.OrderItemMapper;
import com.perhaps.train12306.biz.orderservice.dao.mapper.OrderMapper;
import com.perhaps.train12306.biz.orderservice.dto.domain.OrderStatusReversalDTO;
import com.mingri.train12306.biz.orderservice.dto.req.*;
import com.perhaps.train12306.biz.orderservice.dto.resp.TicketOrderDetailRespDTO;
import com.perhaps.train12306.biz.orderservice.dto.resp.TicketOrderDetailSelfRespDTO;
import com.perhaps.train12306.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import com.perhaps.train12306.biz.orderservice.mq.event.DelayCloseOrderEvent;
import com.perhaps.train12306.biz.orderservice.mq.event.PayResultCallbackOrderEvent;
import com.perhaps.train12306.biz.orderservice.mq.produce.DelayCloseOrderSendProduce;
import com.perhaps.train12306.biz.orderservice.remote.UserRemoteService;
import com.perhaps.train12306.biz.orderservice.remote.dto.UserQueryActualRespDTO;
import com.perhaps.train12306.biz.orderservice.service.OrderItemService;
import com.perhaps.train12306.biz.orderservice.service.OrderPassengerRelationService;
import com.perhaps.train12306.biz.orderservice.service.OrderService;
import com.perhaps.train12306.biz.orderservice.service.orderid.OrderIdGeneratorManager;
